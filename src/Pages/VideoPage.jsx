 ...
 class VideoPage extends Component {
    ...
    render() {
        ...
        return (
            ...
            <CommentSection currentVideo={this.state.currentVideo} videoArray={this.props.videoArray}/>
            </div>
            <NextVideoList currentVideo={this.state.currentVideo} videoArray={this.props.videoArray?.filter(el => el.id !== this.state.currentVideo)} />
